...
from ZSL.IMAGENET_Animal.ZSL_Model.Exp1_GPM_Awa import test_in_train
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--graph',
                        default=os.path.join(DATA_DIR_PREFIX, EXP_NAME, 'imagenet-induced-animal-graph.json'))
    ...
    parser.add_argument('--save_path', default=os.path.join(DATA_DIR_PREFIX, EXP_NAME, 'save-gpm'))
