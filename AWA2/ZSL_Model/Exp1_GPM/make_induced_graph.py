...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', default=os.path.join(DATA_DIR_PREFIX, 'AWA2/materials', 'imagenet-split.json'))
    parser.add_argument('--output', default=os.path.join(DATA_DIR_PREFIX, EXP_NAME, 'imagenet-induced-graph.json'))
    args = parser.parse_args()

    print('making graph ...')
    # length: 32295, content: wnids
    xml_wnids = json.load(open(os.path.join(DATA_DIR_PREFIX, 'materials', 'imagenet-xml-wnids.json'), 'r'))
