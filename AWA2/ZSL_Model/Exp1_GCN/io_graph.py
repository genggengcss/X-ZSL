...
instruction:
construct the input graph and adj matrix
'''
...
def make_corresp():
    seen_file = os.path.join(DATA_DIR_PREFIX, 'IMAGENET_Animal/materials', 'seen_2012_1K_animal.txt')  # num:398
    unseen_file = os.path.join(DATA_DIR_PREFIX, 'AWA2/materials', 'unseen_awa2.txt')  # num: 10
    seen_dict = {}
    unseen_dict = {}
    cnt = 0
    ...
    save_file = os.path.join(DATA_DIR_PREFIX, EXP_NAME, 'corresp-train-test-awa.json')
