# -*- coding: UTF-8 -*-
'''
函数功能：将Awa2 数据集中 以 class text 命名的文件（文件夹及每个文件夹下的图片）修改为以其 对应 wnid 命名。
'''
...
# the wnids and names of awa classes
...
def rename_images():
    ...
    for category in os.listdir(DIR_PATH):
        ...
        if os.path.isdir(os.path.join(DIR_PATH, category)) == True:
            ...
            # wnid = test_wnid[test_name.index(category)]
...
if __name__ == '__main__':
    ...
    # DIR_PATH = '/home/gyx/X_ZSL/data/DGP/AwA/Test_DATA_feats/'
